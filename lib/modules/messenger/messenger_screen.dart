...
import 'package:flutter_login_design/models/user_model.dart';
...
class MessengerScreen extends StatelessWidget {
  ...
  Widget BuildOnlineItem() => SizedBox(
        width: 70,
        child: Column(
          children: [
            Stack(
  ...
  Widget BuildVideoItem() => SizedBox(
        width: 70,
        child: Column(
          children: [
            Stack(
  ...
  Widget BuildUserItem(UserModel user) => SizedBox(
        width: 70,
        child: Column(
          children: [
            Stack(
